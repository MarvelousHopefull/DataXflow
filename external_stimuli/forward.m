...
x=zeros(N,Nt+1);                                              %Number of time steps +1 for the initial state
x(:,1)=OCP.initialState;                                      %Initial value of the state at t=0 equals the initial state of the network
